...
const BookingSummary = ({ booking, payment, isFormValid, onConfirm }) => {
  ...
  //Hàm xử lý xác thực book phòng
  //Xét xử lý thanh toán bằng true sau khi xác nhận book phòng, và set timeout là 3s
  ...
  //Sử dụng UseEffect để xem sự thay đổi khi đặt phòng
  //Nếu đặt phòng thành công thì sẽ chuyển hướng trang đến trang đặt phòng thành công
  useEffect(() => {
