...
const RoomSearch = () => {
  ...
  const handleSearch = (e) => {
    ...
    if (!checkOutMoment.isSameOrAfter(checkInMoment)) {
      setErrorMessage("Check-out date must be after checkin-in date");
      return;
    }
    setIsLoading(true);
  ...
  return (
    <>
      <Container className="shadow mt-n5 mb-5 py-5">
        ...
        {isLoading ? <p className="mt-4">Finding availble rooms....</p> : availableRooms ? <RoomSearchResult results={availableRooms} onClearSearch={handleClearSearch} /> : <p className="mt-4">No rooms available for the selected dates and room type.</p>}
